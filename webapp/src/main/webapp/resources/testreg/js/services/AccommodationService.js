    ...
    return {
	    ...
	    translation : function() {
			return  [
			         	...
			         	{name:"TDS_WL_ArabicGloss&TDS_WL_Glossary",description:"Arabic & English"}, 
			         	{name:"TDS_WL_CantoneseGloss&TDS_WL_Glossary",description:"Cantonese & English"}, 
			         	{name:"TDS_WL_ESNGlossary&TDS_WL_Glossary",description:"Spanish & English"}, 
			         	{name:"TDS_WL_KoreanGloss&TDS_WL_Glossary",description:"Korean & English"},
			         	{name:"TDS_WL_MandarinGloss&TDS_WL_Glossary",description:"Mandarin & English"}, 
			         	{name:"TDS_WL_PunjabiGloss&TDS_WL_Glossary",description:"Punjabi & English"},
			         	{name:"TDS_WL_RussianGloss&TDS_WL_Glossary",description:"Russian & English"},
			         	{name:"TDS_WL_TagalGloss&TDS_WL_Glossary",description:"Filipino (Ilokano and Tagalog) & English"}, 
			         	{name:"TDS_WL_UkrainianGloss&TDS_WL_Glossary",description:"Ukrainian & English"}, 
			         	{name:"TDS_WL_VietnameseGloss&TDS_WL_Glossary",description:"Vietnamese & English"},
	    ...
	    nonEmbeddedDesignatedSupports : function() {
	    	return [
	    	        	...
	    	        	{name:"NEDS_RA_Items_ESN",description:"Read Aloud Items-Spanish"},
	    	        	{name:"NEDS_RA_Stimuli_ESN",description:"Read Aloud PT Stimuli-Spanish"},
	    ...
	    nonEmbeddedAccommodations : function() {
			return  [
						...
						{name:"NEA_RA_Stimuli",description:"Read Aloud CAT Reading Passages"},
